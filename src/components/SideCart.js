        ...
        <>
            <div className="offcanvas offcanvas-end" tabindex="-1" id="offcanvasSideCart" aria-labelledby="offcanvasSideCartLabel">
                ...
                <div className="offcanvas-body">
                    ...
                    <div className="sidecart-price-summary">
                    ...
                    <div className='place-order-sidecart'>
                        ...
                        <div data-bs-dismiss="offcanvas"><Link to="/cart" type="button" className='btn w-100 px-5 py-2 btn-primary'>Continue</Link></div>
                    </div>
